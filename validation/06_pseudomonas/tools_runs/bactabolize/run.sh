...
cp medium_bactabolize.json /opt/Progs/miniconda3/envs/bactabolize/lib/python3.9/site-packages/bactabolize/data/media_definitions/medium_bactabolize_06.json
...
do {
    ...
    bactabolize draft_model \
        ...
        --ref_model_fp iSD1509_M9_edited.xml \
        --biomass_reaction_id BIOMASS_PA14_v27M \
        --media_type medium_bactabolize_06 \
...
do {
    python << EOF
from helper_functions import *
gapfilling_for_bactabolize('iSD1509_M9_edited.xml', '$f', 'gapfilled', dataset='06_streptococcus')
EOF
} & done; wait
